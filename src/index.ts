...
const baseInstructions =
  ...
  'Vendor registry: 50 verified vendors across cloud, CDN, dev-platform, data, comms, auth, monitoring, and AI categories — ' +
  'Atlassian Statuspage plus native adapters for AWS Health, Status.io (GitLab, Neon), Slack, and Firehydrant (Redis Cloud), all normalized to one shape. ' +
